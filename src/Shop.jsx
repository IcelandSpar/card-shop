    ...
    if(isLoading == true) {
        return (
            <section className={styles['loadCardsSection']}>
                    <div className={styles['loadCardsText']}>Loading Cards<div className={styles['loadingDot1']}>.</div><div className={styles['loadingDot2']}>.</div><div className={styles['loadingDot3']}>.</div></div>
            </section>
